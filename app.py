...
def Individual():
    ...
    if flask.request.method =='POST':
        ...
        if dti>43:
            ...
            res= 'Balance annual income too high!'
        elif revol_util>=90:
    ...
    # def excelWrite():
    #     list_all = ['Provided Annual Income','Provided FICO Score','Predicted Interest Rate','Estimated Installment Amount','Number of Payments','Sub Grade','Loan Amount',res]
    #     values_all=[annual_inc,fico_avg_score,int_rate*100,installment,term,sub_grade_to_char,loan_amnt]
    #     workbook1 = openpyxl.load_workbook(
    #     'E:/final_submission/Loan-Pred-Analysis-/report.xlsx')
    ...
    #         i = 0
    #         wks.cell(row=i+1, column=1).value = "FIELDS"
    ...
    #         while i < len(list_all):
    #             if list_all[i] in values_all:
    #                 wks.cell(row=i+2, column=ncol+1).value = "Values"
